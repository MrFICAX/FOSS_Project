            ...
            modelBuilder.Entity("Backend.Models.ClubStatistic", b =>
                {
                    ...
                    b.Property<int?>("TournirClubIDtournir")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TournirClubIDtournir");
            ...
            modelBuilder.Entity("Backend.Models.PlayerStatistic", b =>
                {
                    ...
                    b.Property<int?>("TournirPlayerIDtournir")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TournirPlayerIDtournir");
            ...
            modelBuilder.Entity("Backend.Models.ClubStatistic", b =>
                {
                    ...
                    b.HasOne("Backend.Models.Tournir", "TournirClub")
                        .WithMany("ClubsStatistics")
                        .HasForeignKey("TournirClubIDtournir");

                    b.Navigation("ClubStat");

                    b.Navigation("TournirClub");
                });
            ...
            modelBuilder.Entity("Backend.Models.PlayerStatistic", b =>
                {
                    ...
                    b.HasOne("Backend.Models.Tournir", "TournirPlayer")
                        .WithMany("PlayerStatistics")
                        .HasForeignKey("TournirPlayerIDtournir");

                    b.Navigation("PlayerStat");

                    b.Navigation("TournirPlayer");
                });
